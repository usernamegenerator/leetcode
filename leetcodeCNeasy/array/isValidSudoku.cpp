        ...
        while (k < 9)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    ...
                    if ((board[i + k / 3 * 3][j + k % 3 * 3] - '0') < 0 || (board[i + k / 3 * 3][j + k % 3 * 3] - '0') > 9)
                        continue;

                    if (!isPresent[board[i + k / 3 * 3][j + k % 3 * 3] - '0'])
                    {
                        isPresent[board[i + k / 3 * 3][j + k % 3 * 3] - '0'] = true;
                    }
                    else
                    {
                        return false;
